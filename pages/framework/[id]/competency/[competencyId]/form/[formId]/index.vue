  ...
  sections: [
    {
      ...
      description: "Assess communication effectiveness",
      questions: [
        {
          id: 1,
          type: "rating",
...
// Replace the draggable implementation with this updated version
const sectionsList = ref(null);
const questionsList = ref({});

// Track the dragged elements
...
// Preview form
const previewForm = () => {
  // Implementation for form preview
  ...
  <div>
    ...
    <div class="mb-6">
      <div class="flex justify-between items-center">
        <h1 class="text-xl font-bold text-gray-800">Edit Assessment Form</h1>
        <rs-button variant="secondary" @click="previewForm">
